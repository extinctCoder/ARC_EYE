...
def run(source=0, dispLoc=False):
    ...
    if not cam.isOpened():
        print ('Video device or file couldnt be opened')
        sys.exit()
    while True:
        try:
            print('waitting for the rover')
            ...
            while True:
                ...
                try:
                    ...
                    print ("command send to the rover")
                    print(data)
                except:
                    pass
                # image preview
